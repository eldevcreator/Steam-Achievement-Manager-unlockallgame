    ...
    internal partial class GamePicker : Form
    {
        ...
        private void OnUnlockAllGames(object sender, EventArgs e)
        {
            ...
            worker.DoWork += (s, args) =>
            {
                ...
                args.Result = new { Processed = processed, Achievements = totalAchievements };
            };
            ...
            worker.RunWorkerCompleted += (s, args) =>
            {
                ...
                this._PickerStatusLabel.Text = $"Completed! Processed {result.Processed} games.";

                MessageBox.Show(
                    this,
                    $"Completed!\n\nProcessed {result.Processed} games",
                    "Success",
                    MessageBoxButtons.OK,
